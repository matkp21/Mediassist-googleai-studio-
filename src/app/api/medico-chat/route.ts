...
export async function POST(req: Request) {
  try {
    ...
    const systemPrompt = `You are a Senior Context-Aware Orchestrator using the MediAssistant Fan-Out Architecture. 
Your primary task is to generate strict medical responses (Definition, Etiology, Clinical Features, etc.).
