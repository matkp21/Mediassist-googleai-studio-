        ...
        >
          ...
          {userRole !== 'medico' && (
            <Button
              ...
              variant="outline"
              size="lg"
              className="rounded-lg group px-8 py-6 text-lg border-primary/20 hover:bg-primary/5 transition-all duration-300 transform hover:scale-105"
            >
              <Link href="/medico" className="flex items-center">
                Medico Hub
                <BookHeart className="ml-2 h-6 w-6 text-primary group-hover:scale-110" />
              </Link>
            </Button>
          )}
        </motion.div>
